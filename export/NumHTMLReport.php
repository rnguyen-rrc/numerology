    ...
    PersonalYearCalculator::calculate($objCustomer, (int)date('Y'));
                    ...
                    <div class="number-result">
                        ...
                        <table class="number-table">
                            ...
                            <tr>
                                ...
                                <td><?= is_array($objCustomer->getRaw(NumerologyKeys::HIDDEN_PASSION)) ? implode(", ", $objCustomer->getRaw(NumerologyKeys::HIDDEN_PASSION)) : $objCustomer->getNumber(NumerologyKeys::HIDDEN_PASSION) ?></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            </tr>
